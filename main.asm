...
invalid_input_string BYTE "Input is invalid, try again!", 0
...
.code
    main PROC
        ...
        user_game_mode_loop:
            ...
            je main_game_loop_letter
            cmp user_game_mode, 2
            je main_game_loop_char
